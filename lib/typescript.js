...
const {
	configs: typescriptPluginConfigs,
	// eslint-disable-next-line import/no-unresolved
} = require('@typescript-eslint/eslint-plugin');

// TODO: remove custom rules and use recommended-type-checked and strict-type-checked
// https://typescript-eslint.io/linting/configs/
const typescriptPluginRecommendedRules =
	typescriptPluginConfigs.recommended.rules;

const tsConfigFilename = (function checkForTypescriptEslintConfigFile() {
	...
	overrides: [
		{
			...
			rules: {
				...
				'no-void': 'off', // does not work with @typescript-eslint/no-floating-promises
				...
				// Do not entirely understand rule. TODO: enable later?
				'@typescript-eslint/class-literal-property-style': 'off',

				// Was causing too many issues. TODO: re-enable later?
				'@typescript-eslint/prefer-readonly-parameter-types': 'off',

				// TODO: Enable with typescript 3.9
