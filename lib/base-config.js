		...
		'import/no-extraneous-dependencies': [
			'error',
			{
				devDependencies: [
					...
					'test.{js,jsx,ts,tsx,mjs,cts,mts}', // repos with a single test file
					'test-*.{js,jsx,ts,tsx,mjs,cts,mts}', // repos with multiple top-level test files
					'**/*{.,_}{test,spec}.{js,jsx,ts,tsx,mjs,cts,mts}', // tests where the extension or filename suffix denotes that it is a test
